...
fn test_permute_dyn_f64_2d() {
    ...
    let tensor: TensorDynLen<DynId, f64> = TensorDynLen::new(indices, dims, Arc::new(storage));
...
fn test_permute_dyn_c64_2d() {
    ...
    let tensor: TensorDynLen<DynId, Complex64> = TensorDynLen::new(indices, dims, Arc::new(storage));
