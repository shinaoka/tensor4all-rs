...
29. **Work-log discipline** — DONE: `docs/worklogs/2026-08-11-issue-566-pr4.md` records this PR (session summary, code read, evidence); this ledger is the evidence ledger; the PR body links both.
