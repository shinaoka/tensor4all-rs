...
def dependency_table_of(table: str) -> tuple[str, str | None] | None:
    ...
    # `[workspace.dependencies]` in a virtual root declares versions for members
    # to opt into; the root is not itself a dependent package. Treating it as
    # one falsely blocks routine tenferro revision bumps.
